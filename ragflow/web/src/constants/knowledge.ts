...
export const settledModelVariableMap = {
  [ModelVariableType.Improvise]: {
    temperature: 0.3,  // Reduced from 0.8 for less hallucination
    top_p: 0.9,
  ...
  [ModelVariableType.Precise]: {
    temperature: 0.1,  // Reduced from 0.2 for maximum precision
    top_p: 0.75,
    frequency_penalty: 0.5,
    presence_penalty: 0.6,  // Increased from 0.5 for better responses
    max_tokens: 4096,
  },
  [ModelVariableType.Balance]: {
    temperature: 0.2,  // Reduced from 0.5 for better balance
    top_p: 0.85,
    frequency_penalty: 0.3,
    presence_penalty: 0.4,  // Increased from 0.2 for better responses
    max_tokens: 4096,
  },
};
